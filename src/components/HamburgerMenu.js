  ...
  return (
    <div>
      <div className={`hamburger ${isOpen ? 'active' : ''}`} onClick={toggleMenu}>
        <span className="bar um"></span>
        <span className="bar dois"></span>
      </div>
      ...
      <div className={`nav-content ${isOpen ? 'active' : ''}`}>
        <ul>
          ...
          <li><a href="#contact-form" onClick={toggleMenu}>Contato</a></li>
        </ul>
        ...
        <div className="social-links">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24" width="24">
            <path d="M12 13.295l-7.5-6.3V6h15v0.995l-7.5 6.3z"  stroke="#fff" strokeWidth="1"/>
            <path d="M12 13.295l7.5-6.3V6H4.5v0.995l7.5 6.3z" stroke="#fff" strokeWidth="1"/>
            <path d="M4.5 6H4v12h16V6h-0.5z"  stroke="#fff" strokeWidth="1"/>
            <path d="M4.5 6l7.5 6 7.5-6H4.5z"  stroke="#fff" strokeWidth="1"/>
          </svg>
          </a>
        </div>
